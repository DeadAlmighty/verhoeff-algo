...
int d[10][10] = {
    ...
    {1,2,3,4,0,6,7,8,9,5},
    {2,3,4,0,1,7,8,9,5,6},
    {3,4,0,1,2,8,9,5,6,7},          // this D5 table was factually,logiacally,mathematically and theoretically incorrect in the previous code
    {4,0,1,2,3,9,5,6,7,8},          // and Now it is Csorrect
    {5,9,8,7,6,0,4,3,2,1},
    {6,5,9,8,7,1,0,4,3,2},
    {7,6,5,9,8,2,1,0,4,3},
    {8,7,6,5,9,3,2,1,0,4},
